...
const (
	...
	Unsupported Instance = "Unsupported"
)
...
// IsGRPC is true for all GRPC protocols.
func (p Instance) IsGRPC() bool {
	switch p {
	case GRPC, GRPCWeb:
		return true
	default:
