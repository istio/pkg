...
var _bintree = &bintree{nil, map[string]*bintree{
	"static": {nil, map[string]*bintree{
		"css": {nil, map[string]*bintree{
			"all.css":                   {staticCssAllCss, map[string]*bintree{}},
			"bootstrap-4.0.0.min.css":   {staticCssBootstrap400MinCss, map[string]*bintree{}},
			"dark_syntax-1.14.0.css":    {staticCssDark_syntax1140Css, map[string]*bintree{}},
			"fontawesome-all-5.0.6.css": {staticCssFontawesomeAll506Css, map[string]*bintree{}},
			"fonts.css":                 {staticCssFontsCss, map[string]*bintree{}},
		}},
		"favicons": {nil, map[string]*bintree{
			"android-144x144.png":          {staticFaviconsAndroid144x144Png, map[string]*bintree{}},
			"android-192x192.png":          {staticFaviconsAndroid192x192Png, map[string]*bintree{}},
			"android-36x36.png":            {staticFaviconsAndroid36x36Png, map[string]*bintree{}},
			"android-48x48.png":            {staticFaviconsAndroid48x48Png, map[string]*bintree{}},
			"android-72x72.png":            {staticFaviconsAndroid72x72Png, map[string]*bintree{}},
			"android-96x196.png":           {staticFaviconsAndroid96x196Png, map[string]*bintree{}},
			"apple-touch-icon-180x180.png": {staticFaviconsAppleTouchIcon180x180Png, map[string]*bintree{}},
			"favicon-16x16.png":            {staticFaviconsFavicon16x16Png, map[string]*bintree{}},
			"favicon-32x32.png":            {staticFaviconsFavicon32x32Png, map[string]*bintree{}},
			"favicon.ico":                  {staticFaviconsFaviconIco, map[string]*bintree{}},
			"pwa-192x192.png":              {staticFaviconsPwa192x192Png, map[string]*bintree{}},
			"pwa-512x512.png":              {staticFaviconsPwa512x512Png, map[string]*bintree{}},
			"tile150x150.png":              {staticFaviconsTile150x150Png, map[string]*bintree{}},
			"tile310x150.png":              {staticFaviconsTile310x150Png, map[string]*bintree{}},
			"tile310x310.png":              {staticFaviconsTile310x310Png, map[string]*bintree{}},
			"tile70x70.png":                {staticFaviconsTile70x70Png, map[string]*bintree{}},
		}},
		"img": {nil, map[string]*bintree{
			"exclamation-mark.svg": {staticImgExclamationMarkSvg, map[string]*bintree{}},
		}},
		"js": {nil, map[string]*bintree{
			"bootstrap-4.0.0.min.js":   {staticJsBootstrap400MinJs, map[string]*bintree{}},
			"clipboard-1.7.1.min.js":   {staticJsClipboard171MinJs, map[string]*bintree{}},
			"jquery-3.2.1.slim.min.js": {staticJsJquery321SlimMinJs, map[string]*bintree{}},
			"misc.js":                  {staticJsMiscJs, map[string]*bintree{}},
			"popper-1.12.9.min.js":     {staticJsPopper1129MinJs, map[string]*bintree{}},
			"prism-1.14.0.min.js":      {staticJsPrism1140MinJs, map[string]*bintree{}},
		}},
		"manifest.json": {staticManifestJson, map[string]*bintree{}},
	}},
	"templates": {nil, map[string]*bintree{
		"404.html":  {templates404Html, map[string]*bintree{}},
		"home.html": {templatesHomeHtml, map[string]*bintree{}},
		"layouts": {nil, map[string]*bintree{
			"base.html": {templatesLayoutsBaseHtml, map[string]*bintree{}},
			"main.html": {templatesLayoutsMainHtml, map[string]*bintree{}},
		}},
		"modules": {nil, map[string]*bintree{
			"header.html":       {templatesModulesHeaderHtml, map[string]*bintree{}},
			"last-refresh.html": {templatesModulesLastRefreshHtml, map[string]*bintree{}},
			"sidebar.html":      {templatesModulesSidebarHtml, map[string]*bintree{}},
		}},
	}},
}}
